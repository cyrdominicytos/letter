...
(function () {
    ...
    window["EXT_LIB_DEF_FUNC_BOWSER"] = function () {
        function t(t) {
            ...
            var i = n(/(ipod|iphone|ipad)/i).toLowerCase(), s = /like android/i.test(t), o = !s && /android/i.test(t),
                u = /nexus\s*[0-6]\s*/i.test(t), a = !u && /nexus\s*[0-9]+/i.test(t), f = /CrOS/.test(t),
                l = /silk/i.test(t), c = /sailfish/i.test(t), h = /tizen/i.test(t), p = /(web|hpw)os/i.test(t),
                d = /windows phone/i.test(t), v = /SamsungBrowser/i.test(t), m = !d && /windows/i.test(t),
                g = !i && !l && /macintosh/i.test(t), y = !o && !c && !h && !p && /linux/i.test(t),
                b = n(/edge\/(\d+(\.\d+)?)/i), w = n(/version\/(\d+(\.\d+)?)/i),
                E = /tablet/i.test(t) && !/tablet pc/i.test(t), S = !E && /[^-]mobi/i.test(t), x = /xbox/i.test(t), T;
            /opera/i.test(t) ? T = {
                name: "Opera",
                opera: e,
                ...
                chrome: e,
                version: n(/(?:chrome|crios|crmo)\/(\d+(\.\d+)?)/i)
            } : o ? T = {name: "Android", version: w} : /safari|applewebkit/i.test(t) ? (T = {
                name: "Safari",
                safari: e
            }, w && (T.version = w)) : i ? (T = {name: i == "iphone" ? "iPhone" : i == "ipad" ? "iPad" : "iPod"}, w && (T.version = w)) : /googlebot/i.test(t) ? T = {
                name: "Googlebot",
                googlebot: e,
    ...
    g.toString = function () {
        ...
        a += "image:";
        var b = this.h(), c = this.f(), d = this.c(), f = this.g();
        0 < b && 0 < c && (a += " " + b + " x " + c);
        0 < d && (a += " " + d + "-bit");
        0 < f && (a += " @ " + f + " DPI");
        return a
    ...
    function Ca(a) {
        ...
        if (a && 7 < a.length && "SYSTEM/" == a.substr(0, 7))try {
            ...
            var f = JSON.parse(a.substr(3)), e = f.rr_id, k = f.func, m = f.args;
            J ? J(k, m, function (a, b) {
                try {
                    w.send("RR_RESULT:" + JSON.stringify({rr_id: e, result: {result: a, error: b}}))
                } catch (x) {
                    O("Failed to send response to scan app: " + x, !0)
                }
            }) : w.send("RR_RESULT:" + JSON.stringify({
                    rr_id: e,
                    result: {result: null, error: "reverseRequestHandlerFunc is not set"}
                }))
        } catch (v) {
    ...
    function X(a, b, c, d, f, e, k) {
        ...
        if (k)for (c = 0; c < B.length; c++)if (d = B[c], null != d && d.funcCallId == k) {
    ...
    var Ia = 0, N = n("max_conn_attempts", -1);

    function S(a) {
        if (ea)if (w) y = void 0, w.close(); else {
            a || (u = void 0, Ia += 1);
            ...
            u % 2 != (b ? 0 : 1) && (u += 1);
            if (u < t || u > ja) O("Failed to connect to WebSocket server.", !0), H && H("failed-to-connect"), P(), N = n("max_conn_attempts", -1), !(0 < N) || Ia < N ? S() : (Ia = 0, H && H("failed-to-connect-final")); else {
                y = (new Date).getTime();
                try {
                    b = Ja;
                    var c = a + ":" + u + "/" + ya() + "/";
                    var d = window.location.href;
                    if (null == d)var f = d; else {
                        var e = d.indexOf("#");
    ...
    function Ka() {
        for (var a = document.getElementsByTagName("script"), b = 0; b < a.length; b++) {
            var c = a.item(b), d = new RegExp(L + "\\.js(\\?\\w*)?$");
    ...
    function ua() {
        ...
        -1 < a.indexOf("FORCE_REFRESH") && -1 < window.location.href.indexOf("FORCE_REFRESH") && (a = a.replace(/FORCE_REFRESH/g, "FORCE_REFRESH_" + (new Date).getTime()));
        ...
        null == b && (b = wa.versionCheck("1.7.0_45+") ? "asprise_scan.jar" : "asprise_scan-legacy.jar", b = Y({
            ...
            children: [{name: "param", attributes: {name: "permissions", value: "all-permissions"}}, {
                name: "param",
                attributes: {name: "java_version", value: "1.6+"}
            }, {name: "param", attributes: {name: "java_arguments", value: "-Xmx512m"}}, {
                name: "param",
                attributes: {name: "separate_jvm", value: "true"}
            }, {name: "param", attributes: {name: "codebase_lookup", value: "false"}}, {
                name: "param",
            ...
            if (!b) {
                b = {
                    ...
                    children: [{
                        ...
                        children: [{
                            name: "button",
                            attributes: {"class": "top-right-closer", title: "Dismiss this dialog"}
                        }, {
                            name: "div",
                            attributes: {"class": "asprise-web-scan-setup", style: "margin: auto"},
                            children: [{
                                name: "h2",
                                attributes: {text: "Please complete one-time setup"}
                            }, {
                                name: "table",
                                attributes: {"class": "asprise-web-scan-setup-instruction"},
                                children: [{
                                    name: "tr",
                                    ...
                                    }, {name: "td", attributes: {width: "33%", "class": "run"}}, {
                                        name: "td",
                                    ...
                                    children: [{name: "td", attributes: {colspan: "3"}}]
                                }, {
                                    name: "tr",
                                    ...
                                    children: [{
                                        ...
                                        children: [{
                                            ...
                                            children: [{
                                                name: "a",
                                                attributes: {href: r, target: "_blank", text: "Download"}
                                            }]
                                        }, {
                                            name: "p",
                                            children: [{
                                            ...
                                            }, {name: "span", attributes: {text: ";"}}, {name: "br"}, {
                                                name: "span",
                                                attributes: {style: "font-size: smaller", text: "Other formats: "}
                                            }, {
                                                name: "a",
                                                attributes: {
                                                ...
                                                name: "span",
                                                attributes: {style: "font-size: smaller", text: " \u00b7 "}
                                            }, {
                                                name: "a",
                                                attributes: {
                                                    style: "font-size: smaller",
                                        ...
                                        children: [{name: "h3", attributes: {text: "Run"}}, {
                                            name: "p",
                                            attributes: {text: "Run the setup, follow the instruction;"}
                                        }]
                                    }, {
                                        name: "td",
                                        attributes: {"class": "enjoy"},
                                        children: [{name: "h3", attributes: {text: "Scan"}}, {
                                            name: "p",
                                            attributes: {text: "Viola you're ready to scan!"}
                                        }]
                                    }]
                                }]
                            }, {
                                ...
                                children: [{
                                    name: "span",
                                    attributes: {text: "Already have the scan app set up? "}
                                }, {
                                    name: "a",
                                    attributes: {
                                        "class": "underline",
                        ...
                        children: [{
                            ...
                            children: [{name: "div", attributes: {"class": "icon"}}, {
                                name: "div",
                                children: [{name: "p", attributes: {text: "All set. You may scan now."}}]
                            }]
                        }]
                    }]
                };
    ...
    function Ma(a, b) {
        if (null != a && 0 != a.length)if (0 < b) setTimeout(function () {
            Ma(a)
        }, b); else var c = 1, d = setInterval(function () {
            if (0 >= c) {
                clearInterval(d);
    ...
    function sa() {
        for (var a = !1, b = document.getElementsByTagName("link"), c = 0; c < b.length; c++) {
            var d = b.item(c), f = new RegExp(L + "\\.css(\\?\\w*)?$");
    ...
    function Ja(a) {
        if ("WebSocket" in window)var b = new WebSocket(a); else if ("MozWebSocket" in window) b = new MozWebSocket(a); else return;
    ...
    function Y(a) {
        var b = a.attributes, c = document.createElement(a.name);
        if (null != b)for (var d in b)c.setAttribute(d, b[d]);
        (b = null != b && "text" in b ? b.text : void 0) && c.appendChild(document.createTextNode(b));
        if (a.children instanceof Array)for (a = a.children, b = 0; b < a.length; b++)a[b] && c.appendChild(Y(a[b]));
        return c
    }

    function O(a, b) {
        if (!(da > (b ? 16 : 4)))if (window.console) {
    ...
    function ta() {
        if (0 != modelsToAppendToBodyFromDeployJava.length) {
            ...
            if (null == a) W("Unexcepted error - unable to get body"); else for (var b = 0; b < modelsToAppendToBodyFromDeployJava.length; b++)a.appendChild(Y(modelsToAppendToBodyFromDeployJava[b]))
        }
    }
    ...
    window.scannerjs.getScannedImages = function (a, b, c) {
        ...
        if ("object" === typeof a && a.output instanceof Array)for (var f = a.output, e = 0; e < f.length; e++) {
            var k = f[e];
            if (b && "return-base64" == k.type || c && "return-base64-thumbnail" == k.type) {
                ...
                if ("application/octet-stream" == m) O("Unable to find mime type for " + k.format); else if (k.result instanceof Array)for (var v = 0; v < k.result.length; v++) {
    ...
    window.scannerjs.submitFormWithImages = function (a, b, c) {
        if (b instanceof Array && 0 != b.length) {
            ...
            if (null == e) W("Form doesn't exist: " + a); else {
                a = new FormData(e);
