			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<h4 class="panel-title"><b style="color: blue;"> Détails du courrier <?php echo isset($liste_courrier['num_courrier']) ? $liste_courrier['num_courrier'] : '' ?></b></h4>
					</div>
					...
					<div class="panel-body">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" value="<?php 
                                       ...
                                       $service_dinataire = $CI->CourrierModel->getServiceDestByIdservice($liste_courrier['service_dest']);
                                        ...
                                        echo $service_dinataire->libelle_service; 
                                    ?>" disabled=""  class="form-control">
                                </div>
                            </div>
						...
						<?php 
							...
							<div class="form-group">
                                ...
                                if (!empty($liste_courrier['transferer_par'])) {

                                ?>

                                <div class="col-sm-3">
                                    <label>Transféré par</label>
                                    <input type="text" value="<?php 
                                        $CI =& get_instance();
                                        $CI->load->database();
                                        $CI->load->model('CourrierModel');
                                       $exp = $CI->CourrierModel->getExpByIdAtraiter($liste_courrier['transferer_par']);
