                        ...
                        foreach ($courriers as $item) {
                            ...
                            <tr class="odd gradeX unread">
								...
								<td class="center" style="text-align: center;">
									<a href="<?php echo site_url(); ?>courrier/viewtransferer?id=<?php echo $item['id_dif']; ?>#home2">
								...
								<td class="center" style="text-align: center;">
									<a href="<?php echo site_url(); ?>courrier/viewtransferer?id=<?php echo $item['id_dif']; ?>">
