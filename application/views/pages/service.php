...
<div class="contentpanel">
    ...
    <div class="row">
        ...
        <form id="basicForm" method="post" action="<?php echo site_url(); ?>bureau/service/1"
              class="form-horizontal">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Ajouter un service</h4>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" placeholder="Libelle service" name="libelleservice"
                                       class="form-control"/>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <select name="chefservicefkidemp" class="select2" required data-placeholder="Choisissez...">
                                    ...
                                    if (isset($employe) & count($employe) > 0) {
                                        foreach ($employe as $item) { ?>
                                            <option value="<?php echo $item['id_user'] ?>"><?php echo $item['nom_user'].' '.$item['prenom_user'] ?></option>
                                        <?php }
                                    }
                                    ?>
                                </select>
