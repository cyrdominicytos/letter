...
<div class="contentpanel" style="color:black;">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <a class="btn btn-warning btn-xs pull-right" title="Ajout d'un courrier"
               href="<?php echo site_url() ?>courrier/newcourrier1">
                <span class="fa fa-plus"> Nouveau courrier</span></a>
            <br>
            <br>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="users" data-page-length='25'>
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;">EN COPIES</th>
                        ...
                        foreach ($courriers as $item) {
                            ...
                            <tr class="odd gradeX unread">
                                ...
                                <td class="center" style="text-align: center;">
                                    <a href="<?php echo site_url(); ?>courrier/viewenregistrer1?id=<?php echo $item['id_courrier']; ?>">
                                ...
                                <td class="center" style="text-align: center;">
                                    <a href="<?php echo site_url(); ?>courrier/viewenregistrer1?id=<?php echo $item['id_courrier']; ?>">
                                        <?php echo isset($item['mot_cle']) ? strtoupper($item['mot_cle']) : ''; ?>
                                    </a>
                                </td>
                                <td class="center" style="text-align: center;">
                                    <a href="<?php echo site_url(); ?>courrier/viewenregistrer1?id=<?php echo $item['id_courrier']; ?>">
                                ...
                                <td class="center" style="text-align: center;">
                                    <a href="<?php echo site_url(); ?>courrier/viewenregistrer1?id=<?php echo $item['id_courrier']; ?>">
                                       ...
                                       if(isset($dest))
                                          if(array_key_exists($item['id_courrier'],$dest))
                                            {
                                                ?>
                                                <select class="form-control col-sm-12" >
                                                <?php
                                             foreach ($dest[$item['id_courrier']] as $values)
                                                {
                                                ?>
                                                
                                                    <option class="col-sm-12" ><?php echo strtoupper($values['fullname']) ?></option>
                                ...
                                <td class="center" style="text-align: center;">
                                    <a href="<?php echo site_url(); ?>courrier/viewenregistrer1?id=<?php echo $item['id_courrier']; ?>">
                                       ...
                                       if(isset($copie))
                                          if(array_key_exists($item['id_courrier'],$copie))
                                            {
                                                ?>
                                                <select class="form-control col-sm-12" >
                                                <?php
                                             foreach ($copie[$item['id_courrier']] as $values)
                                                {
                                                ?>
