			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<div class="col-sm-12">
						<a href="<?php echo site_url(); ?>courrier/printt?id=<?php echo $liste_courrier['id_courrier']; ?>#home2">
						<button  type="button" style="font-size: 14px;"  class="col-sm-2 col-sm-offset-5 btn btn-xs btn-warning">
									Imprimer fiche
						</button>
						</a>
						<a href="javascript:history.go(-1)">
						<button  type="button"  style="font-size: 14px;"  class="col-sm-1 col-sm-offset-4 btn btn-xs btn-warning">
									Retour
						</button>
						</a>
					</div>
