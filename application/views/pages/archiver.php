    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <!--a class="btn btn-warning btn-xs pull-right" title="Ajout d'un courrier"
               href="<?php echo site_url() ?>courrier/newcourrier">
                        ...
                        foreach ($courriers as $item) {
                            ...
                            <tr class="odd gradeX unread">
								...
								<td class="center" style="text-align: center;">
									<a href="<?php echo site_url(); ?>courrier/viewarchiver?id=<?php echo $item['id_dif']; ?>#home2">
								...
								<td class="center" style="text-align: center;">
									<a href="<?php echo site_url(); ?>courrier/viewarchiver?id=<?php echo $item['id_dif']; ?>">
								...
								<td class="center" style="text-align: center;">
									<a href="<?php echo site_url(); ?>courrier/viewarchiver?id=<?php echo $item['id_dif']; ?>#home2">
                                       ...
                                       $exp = $CI->CourrierModel->getExpByIdAtraiter($item['exp_courrier']);
                                        
                                        echo strtoupper($exp->prenom_user) . ' ' .strtoupper($exp->nom_user) ; 
                                    ?>
									</a>
								</td>
								<td class="center" style="text-align: center;">
