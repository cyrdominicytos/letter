...
<div class="contentpanel">
	...
	<div class="row">
		...
		<form id="basicForm" method="post"
			  action="<?php echo site_url(); ?>courrier/savefiche?id=<?php echo $liste['idcourrier']; ?>#home2"
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- <a target="_blank" href="<?php echo site_url(); ?>courrier/print?id=<?php echo $liste['idcourrier']; ?>#home2">
						<button style="text-align:center;margin-bottom: 30px; margin-left: 45px;" type="button"  class="col-sm-2 col-sm-offset-1 btn btn-xs btn-warning">
									Imprimer fiche
						</button>
						</a> -->

						<a href="<?php echo site_url(); ?>courrier/deletefiche?id=<?php echo $liste['idcourrier']; ?>#home2"><button style="text-align:center;margin-bottom: 30px;font-size: 14px;" type="button"  class="col-sm-2 col-sm-offset-2  btn btn-xs btn-warning">
									Supprimer document
						</button></a>
						<button style="text-align:center;margin-bottom: 30px;font-size: 14px;" type="submit"  class="col-sm-2 col-sm-offset-1  btn btn-xs btn-warning">
									Enregistrer document
						</button>
						<a href="<?php echo site_url(); ?>courrier/retour?id=<?php echo $liste['idcourrier']; ?>#home2">
						<button style="text-align:center;margin-bottom: 30px;font-size: 14px;" type="button"  class="col-sm-2 col-sm-offset-1  btn btn-xs btn-warning">
									Retour
						</button>
						</a>
						</div>
							...
							<div class="form-group">
								<div class="col-sm-3">
									...
									<input type="text" value="<?php 
                                       ...
                                       $exp = $CI->CourrierModel->getExpByIdAtraiter($liste_courrier['exp_courrier']);
                                        
                                        echo strtoupper($exp->prenom_user).' '.strtoupper($exp->nom_user).' ('.$exp->libelle_service.')' ; 
                                    ?>" disabled=""  class="form-control">
...
// {
// 	var chemein = document.getElementById("id_telechargement").value;
